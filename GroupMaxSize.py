...
def create_asg_groupmaxsize_alarms():
    region = "ap-southeast-1"  # Sesuaikan dengan region AWS kamu
    namespace = "AWS/AutoScaling"  # Namespace untuk Auto Scaling Group
    metric_name = "GroupMaxSize"  # Nama metrik untuk ASG
    threshold = 5  # Threshold untuk GroupMaxSize (sesuaikan dengan kebutuhan)
    ...
    try:
        ...
        for group in auto_scaling_groups:
            ...
            alarm_name = f"ASG-GroupMaxSize-{asg_name}"
...
if __name__ == "__main__":
    create_asg_groupmaxsize_alarms()
